...
- (IBAction)presentVc:(UIButton *)sender {
    ...
    [JKPresentationPopoverTool showWithConfiguration:^JKPresentationPopoverConfiguration *{
        
        return [JKPresentationPopoverConfiguration configurationWithTitleFont:[UIFont systemFontOfSize:14] titleColor:[UIColor colorWithRed:255/255.0 green:204/255.0 blue:0 alpha:1] configuration:^(JKPresentationPopoverConfiguration *configuration) {
    ...
    } viewController:self didPresentBlock:^(BOOL isPresent) { // 监听展现和消失
